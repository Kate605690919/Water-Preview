...
namespace WaterPreview.Util.Infrastructure
{
    public class NinjectControllerFactory : DefaultControllerFactory
    {
        ...
        private void AddBindings()
        {
            ...
            ninjectKernel.Bind<IFlowService>().To<FlowService>();
            ninjectKernel.Bind<IFlowDayService>().To<FlowDayService>();
            ninjectKernel.Bind<IFlowHourService>().To<FlowHourService>();
            ...
            ninjectKernel.Bind<IQualityMeterStatusService>().To<QualityMeterStatusService>();
            ninjectKernel.Bind<IExceptionService>().To<ExceptionService>();
